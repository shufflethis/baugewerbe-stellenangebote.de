  ...
  return (
    <div className="page-container autor-page">
      ...
      <section className="autor-detail">
        <h2>Thomas Sander</h2>
        <p className="autor-role">Gruender & Geschaeftsfuehrer von baugewerbe-stellenangebote.de</p>

        <div className="autor-content">
          <p>
            Thomas Sander gruendete baugewerbe-stellenangebote.de mit der Vision, den Recruiting-Prozess
            im Bereich Baugewerbe grundlegend zu verbessern. Als erfahrener Experte im
          ...
          <p>
            ...
            von Arbeitgebern als auch von Fachkraeften im Baugewerbe-Bereich.
          </p>

          <h3>Expertise</h3>
          <ul>
            <li>Baugewerbe & Branchenkenntnisse</li>
            <li>Personalwesen & Recruiting</li>
            <li>Digitale Jobportale & HR-Tech</li>
            <li>Arbeitsmarktanalysen im Baugewerbe-Bereich</li>
          </ul>
        </div>
      </section>
