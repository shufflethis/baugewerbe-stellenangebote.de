  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von baugewerbe-stellenangebote.de. Mit jahrelanger Erfahrung im
      ...
      <div className="autorenbox-links">
        <a href="https://baugewerbe-stellenangebote.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
